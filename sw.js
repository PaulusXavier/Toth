...
const CACHE_NAME = 'caderno-psi-v18';
const ASSETS = [
  './',
  './index.html',
  './manifest.json',
  ...
  './js/app.js',
  './img/icone-psi-toth-192-tech-mini.png',
  './img/icone-psi-toth-512-tech-mini.png',
  './img/icone-toth-caderno-roxo-azul-tech-mini.png'
];
